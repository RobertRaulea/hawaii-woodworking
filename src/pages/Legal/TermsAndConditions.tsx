...
export const TermsAndConditions: React.FC = () => {
  return (
    <div className="max-w-3xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
      <h1 className="font-serif text-3xl lg:text-4xl font-medium text-stone-900 mb-10 text-center">Termeni și Condiții</h1>
      ...
      <div className="prose prose-amber max-w-none">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">2. Definiții</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">3. Prețuri și modalități de plată</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">4. Livrare și expediere</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">5. Retur și garanție</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">6. Drepturi de proprietate intelectuală</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">7. Litigii</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">8. Modificarea termenilor și condițiilor</h2>
          <p className="mb-4">
        ...
        <section className="mb-8">
          <h2 className="font-serif text-xl font-medium text-stone-900 mb-4">9. Prevederi finale</h2>
          <p className="mb-4">
      ...
      <p className="text-xs text-stone-400 mt-14 text-center tracking-wide">
