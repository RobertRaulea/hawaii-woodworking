/**
 * Romania administrative divisions: județe and their localities.
 * Source: github.com/virgil-av/judet-oras-localitati-romania
 */

export const JUDETE: readonly string[] = [
  "Alba",
  "Arad",
  "Argeș",
  "Bacău",
...
export const LOCALITATI_BY_JUDET: Record<string, readonly string[]> = {
  "Alba": [
    "Abrud",
    "Abrud-Sat",
    "Achimețești",
